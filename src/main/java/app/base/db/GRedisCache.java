...
//        System.out.println(new Date());
        Map<Object, Object> map = redisService.hgetMap(getKey());
//        System.out.println(new Date());
        return map.values().stream().map(value -> wrapper(SerializationUtils.fromJson((String) value, clazz))).collect(Collectors.toList());
    }
